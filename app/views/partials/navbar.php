...
// 2. Bir Sonraki Dili Hesapla (Döngü: TR -> EN -> DE -> TR)
$next_lang_map = [
        'tr' => 'en',
        'en' => 'de',
        'de' => 'tr'
...
$next_label = strtoupper($next_lang); // Buton üzerinde yazacak metin (Örn: EN)
...
// 4. Dil Değiştirme Linki Oluşturucu (Mevcut sayfada kalmayı sağlar)
...
<nav class="navbar">
    <!-- Logo (Ana Sayfaya Giderken Dili Korur) -->
